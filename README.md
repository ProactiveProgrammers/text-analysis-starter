...
- Run the program by typing the following command:
  ...
  - You should run the `textanalysis` program will all of the input files that are stored
    inside of the `text/` directory.
  - You will need to use a graphics viewing program to see the generated
    graphics files that are produced by `textanalysis` and stored in
    `graphics/`.
  - You will need to commit your own version of the graphics files into your
    GitHub repository. If the file was not previously in the GitHub repository
    then you will need to use a `git add` before running `git commit`.
